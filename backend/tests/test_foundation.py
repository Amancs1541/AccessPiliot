...
async def test_database_metadata_creates_all_documented_tables() -> None:
    ...
    assert names == {"identity_providers", "users", "groups", "roles", "applications", "user_groups", "role_assignments", "access_assignments", "access_requests", "approval_steps", "policies", "policy_targets", "audit_logs", "sync_runs", "sync_errors", "provider_resources", "access_packages", "access_package_items", "access_package_assignments", "access_package_eligibility", "onboarding_imports", "onboarding_import_records", "birthright_policies", "bootstrap_credentials", "portal_auth_configs", "breakglass_accounts", "security_settings", "branding_settings", "sod_policies", "sod_policy_entities", "sod_admins", "sod_exceptions", "sod_notification_settings", "sod_notifications", "sod_exception_requests", "notifications", "soc_dashboard_layouts", "application_owners", "nhi_risk_exceptions"}
